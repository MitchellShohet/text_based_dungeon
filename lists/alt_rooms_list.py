hallway_list = [
    ...
    ["A wave of intense heat hits you as you come across a massive lake of flowing lava.",  "There's a pathway of rock that traverses the length of it."],
    ["A wave of intense heat hits you as you come across a massive lake of flowing lava.", "There's a trail of rocks like little island that you can jump across."],
    ...
    ["While travelling through a tunnel, you come across a pair of butterflies.",  "A glimmering, blue mist gently cascades from them as they flutter around."],
    ["While travelling through a tunnel, you come across a pair of lizards skittering vertically along the wall."],
    ["While travelling along the edge of a wide chasm, you glimpse a pair of elephants passing on the opposite side."],
    ["While travelling along the edge of a wide chasm, you glimpse another adventurer",  "fighting a skeleton on the opposite side. She seems confident and bests the monster."],
    ...
    ["While travelling through a tunnel, a family of ducks passes you by.", "One-by-one they each nod to you as they continue their business."],
...
dead_end_list = [
    ...
    ["After travelling an eerily straight hallway for nearly 30 minutes,",  "you finally hit a dead end."],
    ["While travelling a long brick hallway, you suddenly find a wall of a different brick blocking your path."],
    ...
    ["You see ahead that the path you're travelling suddenly drops downward into an abyss.", "You'd fall to your death if you kept going this way."],
    ...
    ["While travelling through the ruins of an old town, you spot the unmistakable glow of a fire ahead!", "It's spreading, and likely won't leave any safe places to avoid it. Gotta turn back!"],
    ["While travelling an open cavern with a massive uncrossable chasm to your left,",  "you suddenly find you're out of path to explore.",  "You hunt for more routes, but eventually accept it's a dead end."],
    ["Something is off. You've been travelling this dark, brick hallway for close to an hour,", "but it seems to be repeating itself? You walk back 50 or so feet and find yourself at the entrance.", "There's somekind of magic on this place, but it's beyond your grasp so it's a deadend."],
    ["After travelling a hallway for some time, you see a violent magical aura exploding continuously ahead!", "You backpedal a few feet before the magic notices you, these things tend to escalate quickly."],
