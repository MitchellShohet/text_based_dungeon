...
hallway_list = [ # TOTAL- 63
    ...
    ["You find yourself in a cavern with a little creek to wander beside.", "The gentle trickling sounds are a welcoming comfort."],
...
dead_end_list = [ # TOTAL- 38
    ...
    ["After a time you start to notice a hellish stench. You press on but it gets worse and worse.", "Eventually you're confident that whatever lies ahead will be the death of you."],
