...
room_list = { 
    "general_explorable" : [
        ...
        Room("Glowing Crystals Room", 
            ...
            MonsterSpawning(5, Goblin, 8, Skeleton), 
            [GlowingCrystal(1, ["BREAK", "INVESTIGATE FURTHER"], " human baby.", action1_avail=True, action2_avail=True), 
                GlowingCrystal(2, ["BREAK", "INVESTIGATE FURTHER"], " chair.", action1_avail=True, action2_avail=True), 
                GlowingCrystal(3, ["BREAK", "INVESTIGATE FURTHER"], "n adult horse.", action1_avail=True, action2_avail=True)]),
