...
room_list = [ 
    ...
    [
        Room("DUNGEON ENTRANCE", 
            ...
            [[], [block_dungeon_entrance], {"block_exit" : [0, 0, " A magnetic force repels the IDOL from the DUNGEON ENTRANCE. You cannot leave that way while carrying it."]}]),
        # Room("IDOL ROOM",
        ...
        Room("VAL'S TRADE CAMP",   #***UPDATE SHOPS TO RESTOCK MORE SLOWLY
        ...
        Room("GARLAND'S TRADE CAMP",   #***UPDATE SHOPS TO RESTOCK MORE SLOWLY
        ...
        Room("HALLWAY",
            ...
            [[pick_alt_room_description], [], {"reveal_passage" : [" You unlocked the door!", "OPEN DOOR"],
                        "change_room" : [Exit(2, Room("TREASURE ROOM 1",
                                                        ...
                                                        None,
                                                        [PileOfMoney(1, 20),
                                                            Chest(0, ["BREAK THE LOCK", "USE A KEY"], "", 8, [misc_options["KEY"], misc_options["BOOK OF FAE LANGUAGE"]])]))]}]),
        Room("HALLWAY",
            ["Placeholder for a hallway with a locked door"],
            [Exit(0), Exit(1)],
            MonsterSpawning(7, Goblin),
            ...
            [[pick_alt_room_description], [], {"reveal_passage" : [" You unlocked the door!", "OPEN DOOR"],
                        "change_room" : [Exit(2, Room("TREASURE ROOM 2",
                                                        ...
                                                        None,
                                                        [PileOfMoney(1, 15),
                                                            Chest(0, ["BREAK THE LOCK", "USE A KEY"], "", 8, [misc_options["KEY"], misc_options["SHIELD"]])]))]}]),
        Room("HALLWAY", 
        ...
        Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_alt_room_description], [], {}]),
        # Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_hallway_description], [], {}]),
        # Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_hallway_description], [], {}]),
        # Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_hallway_description], [], {}]),
        # Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_hallway_description], [], {}]),
        # Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_hallway_description], [], {}]),
        ...
        Room("GOBLIN FORTRESS ENTRANCE",
            ...
            [Exit(0), Exit(1, Room("GOBLIN FORTRESS COURTYARD",
                                    ...
                                    [[add_monsters, block_exit], [add_castle_wave], {"add_monsters" : [1, 1, Goblin],
                                                                                    "block_exit" : [1, 0, ["As you pass through the portcullis you see a castle courtyard.", "There is a statue at it's center, a stone keep to your right, and a far wall with a closed portcullis.", "Suddenly the portcullis behind you slams closed, and you see 3 GOBLINS look to your direction!"]],
                                                                                    "add_castle_wave" : [1],
