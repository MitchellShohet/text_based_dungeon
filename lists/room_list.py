...
from lists.interactables_list import Owl, Pool, Mimic, SleepingMinotaur, Container,  Artisan, Breakable, Inspectable, Chasm, RedHerring, GlowingCrystal, ExitHold, Chest, MagmaRiver, MoneyTree, Tree, Cauldron, NPC, ShopOwner, GlowingTree, Fairy
...
from lists.adjustments_list import block_exit, reveal_mimics, obtain_item, golem_machinery, randomize_container_contents, change_adjustable_argument, ceribane_alchemy, adjustment_print, remove_item, inspect_crystal, inspect_machine, break_the_table, clear_cave_in, add_interactable, add_owl, teleport_sequence, add_to_interactable, money_tree_refresh, change_room_description, change_room, add_monsters, change_monster_spawning, shop_refresh, sea_creature_defeated, tree_inspect_renew, damage_player
...
room_list = [ 
    ...
    [
        ...
        #     [Artisan(0,
        #             ["TALK", "SELL", "HIRE", "ROB"],
        #             "An incredibly frail old woman smiles to you with zero teeth left in her face. She smells fine though.",
        #             "Ceribane",
        ...
        Room("BUFFER ROOM",
            "THIS IS A BUFFER ROOM IT SHOULDN'T BE SEEN IN THE GAME IF IT DOES CALL THE FBI")
        ],
    [
