...
from lists.monsters_list import Goblin, Skeleton, Wizard, MudGolem, Minotaur, MagmaGoblin, FlyingGoblin
...
room_list = [ 
    ...
    [
        Room("DUNGEON ENTRANCE", 
            ...
            [Exit(0, Room("GO HOME", 
                        ["You decide to live rather than do this dungeon nonsense. Probably a good idea."], 
                        None)), Exit(1), Exit(2)],
            None,
    ...
    [
        ...
        Room("GARLAND'S TRADE CAMP",
            ["A large cavern housing a run-down cathedral. Moss and ivy adorn its walls, and stalactites pierce it's ruined roof.", "The interior is disheveled, and the pews have long been scrapped for wood.", "A large wagon is parked in a campsite off the altar, and a short trader smiles up at you from his book."], 
            [Exit(0), Exit(1), Exit(2)],
            None,
            [ShopOwner(0, 
                        ["TALK", "ROB", "BUY", "SELL"], 
        ...
        Room("SKELETON FORTRESS ENTRANCE",
            ...
            [Exit(0), Exit(1, Room("SKELETON FORTRESS COURTYARD",
                                    ...
                                    [ExitHold("PORTCULLIS", ["OPEN"], ["A vertically-sliding, metal gate that keeps enemies out... or in", "it's too heavy."]),
                                        ...
                                        Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                                        Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2)],
                                    [[add_monsters, block_exit, randomize_container_contents], [add_castle_wave], {"add_monsters" : [1, 1, Skeleton],
        ...
        Room("HALLWAY",
            ...
            [Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                ...
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2)],
            [[randomize_container_contents, pick_alt_room_description], [], {"randomize_container_contents" : [HealthPotion(), misc_options["APPLES"], misc_options["WOOD"], None, None]}]),
        Room("HALLWAY",
            ["Placeholder description for a storage room"],
            [Exit(0), Exit(1)],
            MonsterSpawning(7, Goblin),
    ...
    [
        ...
        Room("HALLWAY TO PLATE 1",
            ...
            [Exit(0), Exit(1, Room("HALLWAY TO PLATE 2",
                                    ...
                                    adjustments=[[adjustment_print, add_monsters, pick_alt_room_description], [], {"add_monsters" : [2, 8, Skeleton], "adjustment_print" : [2, " A swarm of skeletons has arrived in this room!"]}]))],
            adjustments=[[adjustment_print, add_monsters, pick_alt_room_description], [], {"add_monsters" : [2, 8, Skeleton], "adjustment_print" : [2, " A swarm of skeletons has arrived in this room!"]}]),
        ...
        Room("MINOTAUR SWARM ROOM",
            ...
            [Exit(0), Exit(1, Room("WIZARD TOWER LIBRARY",
                                    ...
                                    [ExitHold("GATE", ["OPEN"], ["A metal gate with magical glowing runes that keep enemies out... or in"], "it's too heavy."),
                                        ...
                                        Container("TRUNK", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                                        Container("TRUNK", 0, ["OPEN"], "A crate for storing supplies", 0, 2)],
                                    [[add_monsters, block_exit, randomize_container_contents], [add_castle_wave], {"add_monsters" : [1, 1, Wizard],
