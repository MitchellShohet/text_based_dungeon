...
from lists.adjustments_list import block_exit, break_the_table, clear_cave_in, add_interactable, add_owl, teleport_sequence, add_to_interactable, money_tree_refresh, add_to_description, change_room, add_monsters, change_monster_spawning, shop_refresh, sea_creature_defeated, tree_inspect_renew, damage_player
    ...
    [
        ...
        Room("CAVE IN",
            ...
            [Exit(0), Exit(1, Room("EXCAVATOR ROOM",
                                    ...
                                    [Exit(0), Exit(1), Exit(2), Exit(3)],
                                    None,
                                    [Breakable("TABLE", 0, ["CHOP"], " A picnic style table.", 0, 2, contents=misc_options["WOOD"]),
                                        RedHerring("DISPLAY RACK",
                                                    "A metal frame with multiple hooks for hanging tools.",
                                                    ["LICK"],
                                                    " HARBOR: Please stop licking my tools?"),
                                        Artisan(0, 
                                                ["TALK", "ROB", "SELL", "HIRE"],
                                                "A buff woman in her late 50's. Her thin hair is pulled back, and she's covered with sick tattoos.",
                                                "HARBOR",
                                                ["she", "her", "hers"],
            ...
            MonsterSpawning(5, Goblin, 8, Skeleton), 
            [ExitHold("ROCK PILE", "A pile of rocks blocking your path.", ["INSPECT"], " Unless you can INSPECT your way through a cave in, this isn't going away any time soon."),
            ExitHold("TIMBER FRAMES", "Multiple wooden frames meant to support the overhead rocks.", ["INSPECT"], " There seem to be a lot for a tunnel this unremarkable, especially considering they didn't work that well.")],
