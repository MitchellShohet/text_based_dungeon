...
from lists.interactables_list import Owl, Pool, SecretPassage, Mimic, SleepingMinotaur, Container,  Artisan, Breakable, Bed, Inspectable, Chasm, RedHerring, GlowingCrystal, ExitHold, Chest, MagmaRiver, MoneyTree, Tree, Cauldron, NPC, ShopOwner, GlowingTree, Fairy
    ...
    [
        ...
        Room("GOBLIN FORTRESS ENTRANCE",
            ...
            [Exit(0), Exit(1, Room("GOBLIN FORTRESS COURTYARD",
                                    "The courtyard of a castle resettled by GOBLINS.",
                                    [Exit(0)],
                                    None,
                                    [ExitHold("PORTCULLIS", ["OPEN"], "A vertically-sliding, metal gate that keeps enemies out... or in", "it's too heavy."),
                                        ...
                                        RedHerring("STATUE", 0, [], "A statue of a woman with a raised sword on a neighing horse"," It's of an elven woman with a raised sword on a neighing horse. There's a small figure hunched over her lap, and the base is decorated with waves and horses.", 0, 3)],
                                    [[add_monsters, block_exit], [add_castle_wave], {"add_monsters" : [1, 1, Goblin],
                                                                                    "block_exit" : [0, f""" As you pass through the portcullis you see a castle courtyard. There is a statue at it's center, a stone keep to your right, and a far wall with a closed portcullis. \n Suddenly the portcullis behind you slams closed, and you see 3 GOBLINS look to your direction!"""],
                                                                                    "add_castle_wave" : [1],
                                                                                    "change_room_description": [1, "The courtyard of a castle recently relieved of GOBLINS."],
                                                                                    "change_room" : [Exit(1, Room("KEEP INTERIOR", 
        ...
        Room("FAIRY STATUE",
            ...
            [ExitHold("PLAQUE", ["READ"], "An ornate plaque carved into the wall.", "A statue of KANE, one of the ten fairies known to live in this dungeon."),
    ...
    [
        ...
        Room("FAIRY FOUNTAIN",
            ...
            [Fairy(0, 
                    ...
                    "ARUGULA", 
                    ["he", "him", "his", "his", "himself"], 
                    ["Oh, hi...", "Oh that was mine, but- okay...", "Um, please will you go, please?", "Ok, do you have anything nice?", "Oh wow, thanks!", "Umm no thanks.", "Sure, I can teleport you to a room you've been to. It'll cost you though, 40 dollar bills or 20 blades of grass?", "Sure thing, where to?", "All right, take care"],
                    6)]),
        Room("FAIRY FOUNTAIN",
            "A shallow stone fountain with a few inches of standing water. A fairy floats about, as the theme from Zelda plays.",
            [Exit(0)],
            None,
            [Fairy(0, 
                    "A young-looking, humanlike creature with pointy ears and wings that trail mist", 
                    "CASTLE", 
                    ["she", "her", "hers", "her", "herself"], 
