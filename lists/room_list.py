    ...
    [
        ...
        Room("HALLWAY",
            ...
            [ExitHold("LARGE ROCK", ["SIT"], ["A rock that looks good for sitting."], "It's a pretty good spot to sit."),
                LockedDoor(9)],
            [[pick_hallway_description], [], {"reveal_passage" : [" You unlocked the door!", "OPEN DOOR"],
