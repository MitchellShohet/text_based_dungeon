...
from lists.interactables_list import Pool, Chasm, RedHerring, GlowingCrystal, ExitHold, Chest, MagmaRiver, MoneyTree, Tree, Cauldron, NPC, ShopOwner, GlowingTree, Fairy
...
from lists.adjustments_list import block_exit, teleport_sequence, add_to_interactable, money_tree_refresh, add_to_description, change_room, add_monsters, change_monster_spawning, shop_refresh, sea_creature_defeated, tree_inspect_renew, damage_player
...
room_list = [ 
    ...
    [
        ...
        Room("GIANT SEQUOIA CHAMBER",
            ...
            [GlowingTree(1, ["PICK FRUIT", "CHOP", "INSPECT"], " glowing giant sequoia", challenge=15)],
            [[tree_inspect_renew], []]),
        ...
        Room("Fairy Room",
            ...
            [Fairy(0, 
                    ...
                    "Kane", 
                    ["she", "her"], 
                    [" Kane: You look silly.", " Kane: Are you kidding?? I could eat you, give it back!", " Kane: You're a jerk, I don't hang out with jerks. Jerk", " Kane: Sure, I can teleport you to a room you've been to! It'll cost you though, 40 dollar bills or 20 blades of grass!", " Pay Kane to teleport you?", " Kane: Sweet!! Where to?", " Kane: Fine, come back another time though.", " Kane: Buddy you don't have enough dollar bills or blades of grass.", " Kane: All right, see you later!"],
                    6)]),
