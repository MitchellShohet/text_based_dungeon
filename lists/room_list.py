...
from lists.interactables_list import Owl, Pool, SecretTunnel, Mimic, SleepingMinotaur, Container,  Artisan, Breakable, Inspectable, Chasm, RedHerring, GlowingCrystal, ExitHold, Chest, MagmaRiver, MoneyTree, Tree, Cauldron, NPC, ShopOwner, GlowingTree, Fairy
...
room_list = [ 
    ...
    [
        ...
        Room("FAIRY STATUE",
            ...
            [RedHerring("PLAQUE", 0, ["READ"], "An ornate plaque carved into the wall.", 0, 0, "A statue of KANE, one of the nine fairies known to live in this dungeon."),
                SecretTunnel("STATUE", 0, ["INSPECT"], "A statue of KANE, one of the nine fairies known to live in this dungeon.", 5, 2, reveal_tunnel)],
            [[inspectable_renew], [], {"reveal_tunnel" : [" The statue slides to the right, revealing a secret tunnel."],
