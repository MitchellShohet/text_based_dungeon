...
from lists.monsters_list import Goblin, Skeleton, Wizard, MudGolem, Minotaur, FlyingGoblin, FlyingGoblin
...
room_list = [ # TOTAL COUNT- 190, HALLWAYS/FLOOR- 16+2, DEADENDS/FLOOR- 12
    ...
    [ # FLOOR ONE ROOM COUNT- 19/66
        Room("DUNGEON ENTRANCE", 
            ...
            [Exit(0, Room("GO HOME", [""], [Exit(0)])),
                    Exit(1), Exit(2)],
            None,
            [ExitHold("DUNGEON ENTRANCE", [], ["A stone archway with runes markes the entrance to the dungeon."]),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2)],
            [[randomize_container_contents, change_room_description], [block_dungeon_entrance], {"change_room_description" : [2, ["You return to the DUNGEON ENTRANCE."]],
                                                                                                    "block_exit" : [0, 0, " A magnetic force repels the IDOL from the DUNGEON ENTRANCE. You cannot leave that way while carrying it."],
        ...
        Room("SMALL MAGMA RIVER", 
            ...
            [Exit(0)], 
            MonsterSpawning(5, FlyingGoblin, 10, "TWICE"),
        ...
        Room("HALLWAY",
            ...
            [Exit(0), Exit(1)],
            MonsterSpawning(3, Goblin, 5, "TWICE"),
            [Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
        ...
        Room("HALLWAY",
            ...
            [Mimic("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                ...
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2)],
            [[randomize_container_contents, pick_alt_room_description], [reveal_mimics], {"randomize_container_contents" : [HealthPotion(), misc_options["APPLES"], SmokeBomb(), None, None]}]),
        Room("HALLWAY", "Placeholder for a double hallway", [Exit(0), Exit(1, Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, Skeleton), adjustments=[[pick_alt_room_description], [], {}]),)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a double hallway", [Exit(0), Exit(1, Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, Skeleton), adjustments=[[pick_alt_room_description], [], {}]),)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, "TWICE"), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(5, Goblin, 9, Skeleton), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway to deadend", [Exit(0), Exit(1, Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(5, Goblin, 9, Skeleton), [], [[pick_alt_room_description], [], ]),)], MonsterSpawning(5, Goblin, 9, Skeleton), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway to deadend", [Exit(0), Exit(1, Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(5, Goblin, 9, Skeleton), [], [[pick_alt_room_description], [], ]),)], MonsterSpawning(5, Goblin, 9, Skeleton), adjustments=[[pick_alt_room_description], [], {}]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(5, Goblin, 9, Skeleton), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(5, Goblin, 9, Skeleton), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(5, Goblin, 9, Skeleton), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(5, Goblin, 9, Skeleton), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(5, Goblin, 9, Skeleton), [], [[pick_alt_room_description], [], ]),
    ...
    [ # FLOOR 2 COUNT- 17/62
        ...
        Room("SKELETON SWARM ROOM",
            ...
            adjustments=[[add_monsters, change_monster_spawning],
                        [], 
                        {"add_monsters" : [1, 7, Skeleton], "change_monster_spawning" : [2, MonsterSpawning(1, Skeleton, 5, "TWICE")]}]),
        Room("SKELETON FORTRESS ENTRANCE",
            ["Your path opens and you see a stone wall with skulls spanning the width of the chamber.", "The wall has an open portcullis and a lowered drawbridge; over the wall you can see the top of the castle's keep."],
        ...
        Room("HALLWAY",
            ["Placeholder for a hallway with a locked door"],
            [Exit(0), Exit(1)],
            MonsterSpawning(1, Skeleton, 5, Wizard),
            [ExitHold("LARGE ROCK", ["SIT"], ["A rock that looks good for sitting."], "It's a pretty good spot to sit."),
                LockedDoor(13)],
            [[pick_alt_room_description], [], {"reveal_passage" : [" You unlocked the door!", "OPEN DOOR"],
                        "change_room" : [Exit(2, Room("TREASURE ROOM 1",
        ...
        Room("HALLWAY", 
            ...
            [Exit(0), Exit(1)], 
            MonsterSpawning(2, Skeleton, 5, "TWICE"), 
        ...
        Room("HALLWAY",
            ["Placeholder description for a hallway with a locked chest"],
            [Exit(0), Exit(1)],
            MonsterSpawning(3, Skeleton, 6, MudGolem),
            [Chest(0, ["BREAK THE LOCK", "USE A KEY"], " with a tough-looking lock.", 12, [GreaterHealthPotion(), StatMedallion(), 45])],
            [[pick_alt_room_description], {}]),
        Room("HALLWAY",
            ["Placeholder description for a hallway with a mimic"],
        ...
        Room("HALLWAY",
            ["Placeholder description for a hallway storage room"],
            [Exit(0), Exit(1)],
            MonsterSpawning(0, Goblin, 1, "TWICE"),
            [Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                Container("CRATE", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
        ...
        Room("HALLWAY",
            ...
            [[randomize_container_contents, pick_alt_room_description, add_monsters], [reveal_mimics], {"randomize_container_contents" : [HealthPotion(), misc_options["SEA CREATURE MEAT"], SmokeBomb(), PowerBerry(), None],
                                                                                                        "add_monsters" : [1, 2, Goblin]}]),
        Room("HALLWAY", "Placeholder for a double hallway", [Exit(0), Exit(1, Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(4, Skeleton, 9, Wizard), adjustments=[[pick_alt_room_description], [], {}]),)], MonsterSpawning(4, Skeleton, 9, "TWICE"), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a double hallway", [Exit(0), Exit(1, Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(4, Skeleton, 9, Wizard), adjustments=[[pick_alt_room_description], [], {}]),)], MonsterSpawning(4, Skeleton, 9, "TWICE"), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(4, Skeleton, 9, "TWICE"), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway", [Exit(0), Exit(1)], MonsterSpawning(4, Skeleton, 9, Wizard), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway to deadend", [Exit(0), Exit(1, Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, Skeleton, 9, Wizard), [], [[pick_alt_room_description], [], ]),)], MonsterSpawning(4, Skeleton, 9, Wizard), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway to deadend", [Exit(0), Exit(1, Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, Skeleton, 9, Wizard), [], [[pick_alt_room_description], [], ]),)], MonsterSpawning(4, Skeleton, 9, Wizard), adjustments=[[pick_alt_room_description], [], {}]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, Skeleton, 9, Wizard), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, Skeleton, 9, Wizard), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, Skeleton, 9, Wizard), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, Skeleton, 9, "TWICE"), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, Skeleton, 9, "TWICE"), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], None, [], [[pick_alt_room_description], [], {}]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], None, [], [[pick_alt_room_description], [], {}]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], None, [], [[pick_alt_room_description], [], {}]),
    ...
    [ # FINAL FLOOR COUNT- 15/62
        ...
        Room("WIZARD SWARM ROOM",
            ...
            adjustments=[[add_monsters, change_monster_spawning],
                        [], 
                        {"add_monsters" : [1, 7, Wizard], "change_monster_spawning" : [2, MonsterSpawning(1, Wizard, 8, "TWICE")]}]),
        ...
        Room("WIZARD TOWER ENTRANCE",
            ...
            [Exit(0), Exit(1, Room("WIZARD TOWER LIBRARY",
                                    ...
                                    [ExitHold("GATE", ["OPEN"], ["A metal gate with magical glowing runes that keep enemies out... or in"], "it's too heavy."),
                                        ...
                                        Container("TRUNK", 0, ["OPEN"], "A crate for storing supplies", 0, 2),
                                        Container("TRUNK", 0, ["OPEN"], "A crate for storing supplies", 0, 2)],
                                    [[add_monsters, block_exit, randomize_container_contents], [add_castle_wave], {"add_monsters" : [1, 5, Wizard],
                                                                                    "randomize_container_contents" : [GreaterHealthPotion(), SmokeBomb(), MagicWand()],
                                                                                    "block_exit" : [1, 0, ["As you pass through the gate you see 40ft high walls covered in bookcases, each packed with books, pages, notes, and tomes of varying sizes and colors.", "The smell is musky, and a massive staircase leads to the upper floors.", "Suddenly the gate behind you slams closed, and you see 5 WIZARDS look to your direction!"]],
                                                                                    "add_castle_wave" : [1],
        ...
        Room("HALLWAY", 
            ...
            [Exit(0), Exit(1)], 
            MonsterSpawning(2, Wizard, 5, "TWICE"), 
        ...
        Room("HALLWAY", "Placeholder for a hallway to deadend", [Exit(0), Exit(1, Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, MudGolem, 9, Minotaur), [], [[pick_alt_room_description], [], ]),)], MonsterSpawning(4, MudGolem, 9, Minotaur), adjustments=[[pick_alt_room_description], [], {}]),
        Room("HALLWAY", "Placeholder for a hallway to deadend", [Exit(0), Exit(1, Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, MudGolem, 9, Minotaur), [], [[pick_alt_room_description], [], ]),)], MonsterSpawning(4, MudGolem, 9, Minotaur), adjustments=[[pick_alt_room_description], [], {}]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, MudGolem, 9, Minotaur), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, MudGolem, 9, Minotaur), [], [[pick_alt_room_description], [], ]),
        Room("DEADEND", "Placeholder for a deadend", [Exit(0)], MonsterSpawning(4, MudGolem, 9, Minotaur), [], [[pick_alt_room_description], [], ]),
