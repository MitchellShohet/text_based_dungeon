...
from lists.interactables_list import Owl, Pool, Artisan, Breakable, Inspectable, Chasm, RedHerring, GlowingCrystal, ExitHold, Chest, MagmaRiver, MoneyTree, Tree, Cauldron, NPC, ShopOwner, GlowingTree, Fairy
...
room_list = [ 
    ...
    [
        ...
        #     [[add_to_interactable, change_room_description],  #***UPDATE SHOPS TO RESTOCK MORE SLOWLY
