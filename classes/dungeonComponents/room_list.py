...
room_list = { 
    "general_explorable" : [
        ...
        Room("Trader's Camp", "A canvas tent opened in the front reveals a pleasent interior. Currently empty shelves as a woman in her 60's appears to be packing up.", [Exit(0), Exit(1), Exit(2)]),
        Room("Hallway", "Placeholder for a hallway", [Exit(0), Exit(1)]),
        Room("Hallway", "Placeholder for a hallway", [Exit(0), Exit(1)]),
        Room("Hallway", "Placeholder for a hallway", [Exit(0), Exit(1)]),
        Room("Hallway", "Placeholder for a hallway", [Exit(0), Exit(1)]),
        Room("Hallway", "Placeholder for a hallway", [Exit(0), Exit(1)]),
